...
<main class="hero">
    ...
    <div class="hero-img">
        <img src="<c:url value='/images/3d_icon/airplane.png'/>" alt="비행기 이미지">
    </div>
</main>
...
<section class="features">
    <div class="card">
        <div class="card-icon">
            <img src="<c:url value='/images/3d_icon/map.png'/>" alt="지도 이미지">
        </div>
        <h3>AI가 고른 오늘의 여행</h3>
    ...
    <div class="card">
        <div class="card-icon">
            <img src="<c:url value='/images/3d_icon/star.png'/>" alt="별 이미지">
        </div>
        <h3>추천 목록에 담기</h3>
    ...
    <div class="card">
        <div class="card-icon">
            <img src="<c:url value='/images/3d_icon/feedback.png'/>" alt="피드백 이미지">
        </div>
        <h3>좋아요/싫어요 피드백</h3>
    ...
    <div class="card">
        <div class="card-icon">
            <img src="<c:url value='/images/3d_icon/conversation.png'/>" alt="소통 이미지">
        </div>
        <h3>함께 나누는 여행</h3>
...
<script src="<c:url value='/js/recommend/main.js'/>"></script>
