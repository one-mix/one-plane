...
<main class="main-container">
    <div class="top-tabs-wrapper">
        <div class="top-tabs">
            <a href="/myPost/myPost" class="top-tab ${empty selectedCategory ? 'active' : ''}">전체</a>
        ...
        <div class="conversion">
            <a href="?tab=my" class="top-tab ${tab == 'my' ? 'active' : ''}">내가 작성한</a>
            <a href="?tab=follower" class="top-tab ${tab == 'follower' ? 'active' : ''}">팔로워가 작성한</a>
        </div>
