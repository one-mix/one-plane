    ...
    <div class="top-tabs-wrapper">
        <div class="top-tabs">
            <a href="<c:url value='/api/posts/following/${currentUserId}'/>"
               class="top-tab ${empty selectedCategory ? 'active' : ''}">전체</a>
            <a href="<c:url value='/api/posts/following/${currentUserId}/category?category=READY'/>"
               class="top-tab ${selectedCategory eq 'READY' ? 'active' : ''}">준비</a>
            <a href="<c:url value='/api/posts/following/${currentUserId}/category?category=REVIEW'/>"
               class="top-tab ${selectedCategory eq 'REVIEW' ? 'active' : ''}">후기</a>
            <a href="<c:url value='/api/posts/following/${currentUserId}/category?category=ACCOMPANY'/>"
               class="top-tab ${selectedCategory eq 'ACCOMPANY' ? 'active' : ''}">동행</a>
            <a href="<c:url value='/api/posts/following/${currentUserId}/category?category=FREE'/>"
               class="top-tab ${selectedCategory eq 'FREE' ? 'active' : ''}">자유</a>
        </div>
